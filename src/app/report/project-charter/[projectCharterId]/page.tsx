...
const ProjectCharterShow = ({params}: { params: { projectCharterId: string } }) => {
    ...
    const NoDataComponent = ({v} : NoDataProp) => {
       return <div className={`flex border-r border-l border-b ${v === 1 && 'border-t'} border-gray-500`}>
            <p className="flex-shrink-0 w-full text-start md:text-center font-semibold p-1 ">No
                Data </p>
        </div>
    }
        ...
        return (
            <div className='flex flex-col bg-white p-2 shadow-md text-xs'>
                        ...
                        <div className='flex mb-1'>
                            ...
                            <p className='font-medium'>
                                {project?.representatives?.length > 0 ?
                                    <>{project?.representatives.map(item => <span
                        ...
                        <div className="min-w-[750px]">
                            <div className='ml-12'>
                                <div className="flex border-l border-t border-b border-gray-500 font-semibold">
                                    ...
                                    <p className="flex-grow w-24 p-1 border-r border-gray-500 overflow-x-auto">Name/Title/Organization</p>
                                            ...
                                            <>
                                                {
                                                    project?.stakeholders.map((item, index) =>
                                                        <div key={item.id}
                                                             className="flex border-l  border-b border-gray-500">
                ...
                <div className='flex flex-col mb-3'>
                    ...
                    <div className='flex flex-col mb-3 ml-12'>
                        <p>{project?.purpose}</p>
                    </div>
                    <div className='flex flex-col mb-3 pl-12'>
                        ...
                        <div className="overflow-x-auto">
                            <div className="min-w-[750px]">
                                <div className='ml-12'>
                                    <div className="flex border-l border-t border-b border-gray-500 font-semibold">
                                        <p className="flex-shrink-0 w-12 p-1 border-r border-gray-500"></p>
                                        <p className="flex-grow w-48 p-1 border-r border-gray-500">Strategic Plan
                                            Element</p>
                                        <p className="flex-grow w-24 p-1 border-r border-gray-500">Project Business
                                            Objective</p>
                                    </div>
                                    <>
                                        {
                                                ...
                                                <>
                                                    {
                                                        project?.constraints?.map((item, index) =>
                                                            <div key={item.id}
                                                                 className="flex border-l b border-b border-gray-500">
                                            ...
                                            <>
                                                {
                                                    project?.deliverables?.map((item, index) =>
                                                        <div key={item.id}
                                                             className="flex border-l border-t border-b border-gray-500">
                                                            <p className="flex-shrink-0 w-12 p-1 border-r border-gray-500">{index + 1}</p>
                                                            <p className="flex-grow w-24 p-1 border-r border-gray-500">{item?.name}</p>
                            ...
                            <div className="min-w-[750px]">
                                <div className='ml-12'>
                                    <div className="flex border-l border-t border-b border-gray-500 font-semibold">
                                        ...
                                        <p className="flex-grow w-24 p-1 border-r border-gray-500">Roles and
                                            Responsibilities</p>
                                    </div>
                                    <>
                                        {
                                ...
                                <>
                                    {
                                        project?.approvals?.length > 0 ?
                                            ...
                                            <div className="flex border-l border-b border-gray-500">
                                                <p className="flex-shrink-0 w-full text-start md:text-center font-semibold p-1 border-r border-gray-500">
                                                    <span className='text-red-500'>*</span> Pending </p>
                                            </div>
                                    }
                                </>
                            </div>
